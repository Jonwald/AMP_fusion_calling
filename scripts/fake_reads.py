...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 16 17:31:47 2021
...
def parse_command(command):
    ...
    parser.add_argument('-l', '--readlen', type=int, required=True, help='length of fake paired end reads')
    parser.add_argument('-n', '--numfrags', type=int, required=True, help='length of fake paired end reads')
    parser.add_argument('-e', '--err_prob', type=float, required=True, help='probabilty of substitution (per base) value between 0.00 and 1')
...
## inputs ##
    ...
    print("generating fake reads with the following settings:")
    print("reference fasta = " + input_file)
    print("random substitution rate = " + str(err_prob))
    print("read length = " + str(readlen))
    print("number of fragments = "+ str(numfrags))
    print("output R1 file = " + output_read1)
    print("output R2 file = " + output_read2)
